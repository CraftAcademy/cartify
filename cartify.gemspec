...
Gem::Specification.new do |s|
  ...
  s.email       = ['info@craftacademy.se']
  s.homepage    = 'https://github.com/Craftacademy/cartify'
  ...
  s.add_dependency 'rails', '~> 5.1', '>= 6.0.1'
  ...
  s.add_dependency 'tippy_rails', '~> 2.5', '>= 2.5.2'
  s.add_dependency 'bootstrap', '~> 4.1', '>= 4.1.1'
